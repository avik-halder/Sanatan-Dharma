          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-orange-700 max-w-3xl mx-auto">
                Hindu festivals celebrate various aspects of life, mythology,
                and cosmic events
              </p>
            </motion.div>
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <button
                      ...
                      className="text-orange-600 p-0 underline"
                    >
        ...
        <section className="py-16 bg-orange-100" id="festival-calendar">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-orange-700 max-w-3xl mx-auto">
                Hindu festivals follow the lunar calendar and vary by region and
                tradition
              </p>
            </motion.div>
              ...
              <div className="relative right-0">
                ...
                >
                  <li className="z-30 flex-auto text-center">
                    <button
                      className={`z-30 flex items-center justify-center w-full px-0 py-2 text-md font-medium sm:font-semibold mb-0 transition-all ease-in-out border-0 rounded-lg cursor-pointer text-orange-800 ${
                        selectedTab === "spring" ? "bg-white" : "bg-inherit"
                      }`}
                  ...
                  <li className="z-30 flex-auto text-center">
                    <button
                      className={`z-30 flex items-center justify-center w-full px-0 py-2 mb-0 text-md font-medium sm:font-semibold transition-all ease-in-out border-0 rounded-lg cursor-pointer text-orange-800 ${
                        selectedTab === "summer" ? "bg-white" : "bg-inherit"
                      }`}
                  ...
                  <li className="z-30 flex-auto text-center">
                    <button
                      className={`z-30 flex items-center justify-center w-full px-0 py-2 text-md font-medium sm:font-semibold mb-0 transition-all ease-in-out border-0 rounded-lg cursor-pointer text-orange-800 ${
                        selectedTab === "autumn" ? "bg-white" : "bg-inherit"
                      }`}
                  ...
                  <li className="z-30 flex-auto text-center">
                    <button
                      className={`z-30 flex items-center justify-center w-full px-0 py-2 text-md font-medium sm:font-semibold mb-0 transition-all ease-in-out border-0 rounded-lg cursor-pointer text-orange-800 ${
                        selectedTab === "winter" ? "bg-white" : "bg-inherit"
                      }`}
              ...
              <div className="max-w-2xl w-full">
                {selectedTab === "spring" && (
                  <div className="grid gap-8 bg-white border-[1px] border-orange-500 p-6 rounded-md shadow-md">
                    {[
                      {
                        name: "Holi",
                        date: "Phalgun Purnima (February/March)",
                        description:
                          "The festival of colors celebrating the arrival of spring and the victory of good over evil.",
                      },
                      {
                        name: "Ugadi/Gudi Padwa",
                        date: "Chaitra Shukla Pratipada (March/April)",
                        description:
                          "New Year's Day for many Hindus, especially in South and Western India.",
                      },
                      {
                        name: "Ram Navami",
                        date: "Chaitra Shukla Navami (March/April)",
                      ...
                      <div
                        key={festival.name}
                        className="border-b-2 border-dashed border-orange-200 pb-4 last:border-0 last:pb-0"
                      >
                ...
                {selectedTab === "autumn" && (
                  <div className="grid gap-8 bg-white border-[1px] border-orange-500 p-6 rounded-md shadow-md">
                    {[
                      ...
                      {
                        name: "Onam",
                        date: "Bhadrapada/Ashwin (August/September)",
                        description: "Harvest festival celebrated in Kerala.",
                      },
                      {
                        name: "Durga Puja",
                        date: "Ashwin Shukla Pratipada to Navami (September/October)",
                        description:
                          "Worship of Goddess Durga, particularly in Bengal.",
                      },
                      {
                        name: "Navratri",
                        date: "Ashwin Shukla Pratipada to Navami (September/October)",
                        description:
                          "Nine nights dedicated to the Goddess Durga.",
                      },
                      {
                        name: "Dussehra",
                        date: "Ashwin Shukla Dashami (September/October)",
                        description: "Victory of Lord Rama over Ravana.",
                      },
                      {
                        name: "Diwali",
                        date: "Kartika Amavasya (October/November)",
                        description:
                ...
                {selectedTab === "winter" && (
                  <div className="grid gap-8 bg-white border-[1px] border-orange-500 p-6 rounded-md shadow-md">
                    {[
                      {
                        name: "Pancha Ganapati",
                        date: "December 21-25",
                        description: "Five-day festival honoring Lord Ganesha.",
                      },
                      {
                        name: "Lohri",
                        date: "January 13",
                        description:
                          "Harvest festival celebrated in North India.",
                      },
                      {
                      ...
                      },
                      {
                        ...
                        date: "Magha Shukla Panchami (January/February)",
                        description:
                          "Festival honoring Saraswati, the goddess of knowledge.",
                      },
                      {
                        name: "Maha Shivaratri",
                        date: "Phalguna Krishna Chaturdashi (February/March)",
